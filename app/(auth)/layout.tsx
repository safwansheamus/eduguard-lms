...
const AuthLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="h-screen flex overflow-hidden" style={{ backgroundImage: 'url("https://raw.githubusercontent.com/safwansheamus/eduguard-lms/main/public/kambing.png")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="w-90 flex items-center justify-end overflow-hidden">
        <div className="p-80 bg-transparent">
          {children}
        </div>
      </div>
    </div>
